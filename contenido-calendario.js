...
const CALENDARIO = [
...

  {
    ...
    buenosDias: "Música alegre para recordar que caminar juntos es lo mejor.",
    poema: [
    ...
    buenasNoches: "Que descanses plácidamente.",
...

  {
    ...
    tono: "amor",
    color: { principal: "#6b8f9e", suave: "#c9e2ea", oscuro: "#0a1a20" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción sobre querer ser el único lugar al que alguien quiera volver.",
    poema: [
    ...
    buenasNoches: "Buenas noches, siendo, espero, tu única persona en este plan.",
...

  {
    ...
    buenosDias: "Letras crudas y sinceras para un día de reflexión y tranquilidad.",
    poema: [
    ...
    buenasNoches: "Que tengas una noche sumamente tranquila.",
...

  {
    ...
    tono: "amor",
    color: { principal: "#c9a267", suave: "#f2e0bd", oscuro: "#221805" },
    buenosDias: "Melodías relajantes y letras profundas para un día tranquilo.",
    poema: [
    ...
    buenasNoches: "Cierra los ojos y descansa con tranquilidad.",
...

  {
    ...
    buenosDias: "Música alegre para mantener el buen humor durante toda la jornada.",
    poema: [
    ...
    buenasNoches: "Duerme rico, te pienso un montón.",
    notaImagen: "[MÚSICA] Canción: Contigo",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },
...

  {
    ...
    tono: "amor",
    color: { principal: "#c9a267", suave: "#f2e0bd", oscuro: "#221805" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción sobre disfrutar la vida a pesar de lo difícil que a veces se pone.",
    poema: [
    ...
    buenasNoches: "Buenas noches, agradecido de vivir mi vida contigo cerca.",
...

  {
    ...
    buenosDias: "Buenos días. Hoy armé una playlist mental que solo pienso mostrarte a ti, y no es precisamente de canciones para escuchar con la familia.",
    poema: [
      "Hay una versión mía con volumen bajo y luces apagadas que solo sale contigo.",
      "Esa playlist privada sigue esperando que la estrenemos juntos."
    ],
    detalle: "Cuando estemos cerca, dale play tú misma.",
    buenasNoches: "Buenas noches, con la playlist todavía guardada, esperando el momento.",
    notaImagen: "[PARA TI] a tu criterio.",
    notaCancion: "[PARA TI] automática, catálogo 'hot'."
  },
...

  {
    ...
    tono: "amor",
    color: { principal: "#c98f9e", suave: "#f7d9e2", oscuro: "#26101a" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción sobre todo lo que alguien estaría dispuesto a hacer con tal de que la otra persona sienta lo mucho que la quieren.",
    poema: [
    ...
    buenasNoches: "Buenas noches, esperando que hayas sentido, aunque sea un poco, todo esto.",
    notaImagen: "[PARA TI] a tu criterio.",
...

  {
    ...
    tono: "amor",
    color: { principal: "#6b8f9e", suave: "#c9e2ea", oscuro: "#0a1a20" },
    buenosDias: "Ritmo urbano para mantener presente a esa persona especial.",
    poema: [
    ...
    buenasNoches: "Que descanses, te pienso un montón.",
...

  {
    ...
    buenosDias: "Buenos días. Hoy pensé en esos momentos que solo pasan a oscuras, sin necesitar ver para saber que todo va bien.",
    poema: [
      "Hay una confianza distinta cuando se apagan las luces y aun así todo se siente seguro.",
      "Contigo esa confianza ya la tengo, completa."
    ],
    detalle: "Cuando quieras repetir esa confianza a oscuras, avísame.",
    buenasNoches: "Buenas noches, a oscuras, pensando en ti.",
    notaImagen: "[PARA TI] a tu criterio.",
    notaCancion: "[PARA TI] automática, catálogo 'hot'."
  },

  {
    ...
    buenosDias: "Los acordes de bajo y las letras directas tienen un encanto único.",
    poema: [
    ...
    buenasNoches: "Que tengas una noche muy placentera.",
...

  {
    ...
    tono: "hot",
    color: { principal: "#c81d4a", suave: "#f7c0d0", oscuro: "#1a0308" },
    buenosDias: "Buenos días. Hoy va un extra que normalmente no se cuenta, pero contigo hago excepciones.",
    poema: [
      "Hay pensamientos que quedan fuera del mensaje normal, como contenido extra que solo desbloqueas cerca.",
      "Este es uno de esos bonus, pendiente de entregar en persona."
    ],
    detalle: "Cóbrame el bonus la próxima vez que nos veamos.",
    buenasNoches: "Buenas noches, con el bonus todavía pendiente.",
    notaImagen: "[PARA TI] a tu criterio.",
    notaCancion: "[PARA TI] automática, catálogo 'hot'."
  },
...

  {
    ...
    tono: "filosofica",
    color: { principal: "#c98f9e", suave: "#f7d9e2", oscuro: "#26101a" },
    buenosDias: "Letras nostálgicas y hermosas para empezar la mañana con calma.",
    poema: [
    ...
    buenasNoches: "Descansa rico, nos leemos mañana.",
...

  {
    ...
    tono: "amor",
    color: { principal: "#c9a267", suave: "#f2e0bd", oscuro: "#221805" },
    buenosDias: "Ritmo urbano para mantener arriba la energía en la recta final.",
    poema: [
    ...
    buenasNoches: "Que descanses profundamente.",
...

  {
    ...
    tono: "amor",
    color: { principal: "#6b8f9e", suave: "#c9e2ea", oscuro: "#0a1a20" },
    buenosDias: "¡Llegamos a los 180 días! Y lo celebramos con buena música.",
    poema: [
    ...
    buenasNoches: "Descansa profundamente, amor.",
    notaImagen: "[MÚSICA] Canción: Colapso",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },
...

  {
    ...
    tono: "amor",
    color: { principal: "#c9a267", suave: "#f2e0bd", oscuro: "#221805" },
    buenosDias: "Un estilo único que atrapa desde el primer acorde de bajo.",
    poema: [
    ...
    buenasNoches: "Que el descanso de esta noche sea reparador y silencioso.",
    notaImagen: "[MÚSICA] Canción: I Wanna Be Yours",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },

  {
    ...
    tono: "hot",
    color: { principal: "#a10e35", suave: "#f0aabd", oscuro: "#140208" },
    buenosDias: "Buenos días. Hay conversaciones que prefiero tener a puerta cerrada, sin pantallas de por medio.",
    poema: [
      "Hoy tengo varias de esas guardadas, de las que no se escriben completas por mensaje.",
      "Cuando estemos solos, ahí sí hablamos con calma."
    ],
    detalle: "Anota el tema pendiente para la próxima vez que estemos a solas.",
    buenasNoches: "Buenas noches, con la conversación pendiente todavía guardada.",
    notaImagen: "[PARA TI] a tu criterio.",
    notaCancion: "[PARA TI] automática, catálogo 'hot'."
  },
...

  {
    ...
    tono: "amor",
    color: { principal: "#c9a267", suave: "#f2e0bd", oscuro: "#221805" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción sobre encontrar consuelo en la mirada de alguien, incluso en los días tristes.",
    poema: [
    ...
    buenasNoches: "Buenas noches, con tus ojitos lindos todavía en la cabeza.",
    notaImagen: "[PARA TI] a tu criterio.",
...

  {
    ...
    tono: "filosofica",
    color: { principal: "#c98f9e", suave: "#f7d9e2", oscuro: "#26101a" },
    buenosDias: "Un recordatorio musical de que el cariño cruza cualquier distancia.",
    poema: [
    ...
    buenasNoches: "Que descanses, soñando con lo que viene.",
    notaImagen: "[MÚSICA] Canción: Sigo Extrañándote",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },
...

  {
    ...
    tono: "amor",
    color: { principal: "#9e8fc9", suave: "#e2d9f7", oscuro: "#160f26" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción bien simple: la de ser el favorito de alguien.",
    poema: [
    ...
    buenasNoches: "Buenas noches, mi favorita, como siempre.",
...

  {
    ...
    tono: "amor",
    color: { principal: "#9e8fc9", suave: "#e2d9f7", oscuro: "#160f26" },
    buenosDias: "Baladas intensas para cerrar los últimos días con sentimiento.",
    poema: [
    ...
    buenasNoches: "Que la noche te traiga calma absoluta.",
    notaImagen: "[MÚSICA] Canción: Amor Completo",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },
...

  {
    ...
    tono: "filosofica",
    color: { principal: "#6b8f9e", suave: "#c9e2ea", oscuro: "#0a1a20" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción de rock en español sobre un amor tan intenso que se compara con el sol.",
    poema: [
    ...
    buenasNoches: "Buenas noches, con esa intensidad todavía rayando, como el sol de la canción.",
    notaImagen: "[PARA TI] a tu criterio.",
...

  {
    ...
    tono: "amor",
    color: { principal: "#6b8f9e", suave: "#c9e2ea", oscuro: "#0a1a20" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción sobre lo mucho que se extraña a alguien cuando no está.",
    poema: [
    ...
    buenasNoches: "Buenas noches, sin nada que reclamarte, todo bien como está.",
    notaImagen: "[MÚSICA] Canción: Contigo",
...

  {
    ...
    tono: "amor",
    color: { principal: "#6b8f9e", suave: "#c9e2ea", oscuro: "#0a1a20" },
    buenosDias: "Una melodía dulce para arrancar la mañana con una sonrisa.",
    poema: [
...

  {
    ...
    tono: "hot",
    color: { principal: "#a10e35", suave: "#f0aabd", oscuro: "#140208" },
    buenosDias: "Buenos días. Hoy imaginé algo simple: los dos compartiendo audífonos, muy cerca, sin decir nada.",
    poema: [
      "Hay una cercanía distinta cuando se comparte música así, casi oído con oído.",
      "Quiero esa escena contigo, pronto, real."
    ],
    detalle: "Trae tus audífonos la próxima vez, tengo varias canciones para ese momento.",
    buenasNoches: "Buenas noches, con ganas de esa cercanía pronto.",
    notaImagen: "[PARA TI] a tu criterio.",
    notaCancion: "[PARA TI] automática, catálogo 'hot'."
  },

  {
    ...
    tono: "amor",
    color: { principal: "#9e8fc9", suave: "#e2d9f7", oscuro: "#160f26" },
    buenosDias: "Acordes luminosos para arrancar el día con una sonrisa.",
    poema: [
    ...
    buenasNoches: "Cierra los ojos y descansa con paz.",
...

  {
    ...
    tono: "amor",
    color: { principal: "#9e8fc9", suave: "#e2d9f7", oscuro: "#160f26" },
    buenosDias: "Baladas intensas para empezar el día con los sentimientos al tope.",
    poema: [
...

  {
    ...
    tono: "amor",
    color: { principal: "#c9a267", suave: "#f2e0bd", oscuro: "#221805" },
    buenosDias: "Buenos días, reina. Hoy quiero hablarte de una canción sobre tratar a alguien como se merece, aunque actúe como si no lo necesitara.",
    poema: [
    ...
    buenasNoches: "Buenas noches, reina. Descansa como te mereces.",
    notaImagen: "[PARA TI] a tu criterio.",
...

  {
    ...
    tono: "filosofica",
    color: { principal: "#c9a267", suave: "#f2e0bd", oscuro: "#221805" },
    buenosDias: "A un solo paso de completar los doscientos días con la mejor música.",
    poema: [
    ...
    buenasNoches: "Que duermas de la mejor manera.",
    notaImagen: "[MÚSICA] Canción: Yellow",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },
...

  {
    ...
    tono: "hot",
    color: { principal: "#d1163f", suave: "#f7bccb", oscuro: "#1c0409" },
    buenosDias: "Buenos días. Hay momentos que se disfrutan tanto que uno solo piensa en cuándo se repiten.",
    poema: [
      "No te voy a decir a cuál me refiero exactamente, pero sé que tú también lo sabes.",
      "Cuando quieras el bis, aquí estoy, disponible."
    ],
    detalle: "Pide el bis cuando quieras, no me voy a hacer rogar.",
...

  {
    ...
    tono: "hot",
    color: { principal: "#e0294f", suave: "#ffc9d6", oscuro: "#20050b" },
    buenosDias: "Buenos días. Hoy quiero hablarte bajito, como cuando algo es solo entre los dos.",
    poema: [
      "No todo se dice a todo volumen, algunas cosas suenan mejor casi en susurro, cerca del oído.",
      "Así quiero decirte lo que pienso hoy: bajito, cerca, sin prisa."
    ],
    detalle: "Acércate para que te lo diga bien, en persona.",
    buenasNoches: "Buenas noches, todavía con ganas de decirte cosas bajito.",
    notaImagen: "[PARA TI] a tu criterio.",
    notaCancion: "[PARA TI] automática, catálogo 'hot'."
  },
...

  {
    ...
    tono: "filosofica",
    color: { principal: "#c98f9e", suave: "#f7d9e2", oscuro: "#26101a" },
    buenosDias: "Pop romántico para dedicar a distancia.",
    poema: [
    ...
    buenasNoches: "Que duermas bien, sabiendo que eres lo último en lo que pienso.",
    notaImagen: "[MÚSICA] Canción: Just the Way You Are",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },
...

  {
    ...
    tono: "amor",
    color: { principal: "#6b8f9e", suave: "#c9e2ea", oscuro: "#0a1a20" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción costeña sobre sentir que la vida cambia completamente gracias a alguien.",
    poema: [
    ...
    buenasNoches: "Buenas noches, sintiendo que la vida mejoró, gracias a ti.",
    notaImagen: "[PARA TI] a tu criterio.",
...

  {
    ...
    tono: "filosofica",
    color: { principal: "#6b8f9e", suave: "#c9e2ea", oscuro: "#0a1a20" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción sobre buscar calma en medio del ruido de la cabeza.",
    poema: [
    ...
    buenasNoches: "Buenas noches, esperando buenas noticias, más tranquilo gracias a ti.",
    notaImagen: "[MÚSICA] Canción: Sigo Extrañándote",
...

  {
    ...
    tono: "filosofica",
    color: { principal: "#c98f9e", suave: "#f7d9e2", oscuro: "#26101a" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción que compara a alguien con algo tan grande como las estrellas.",
    poema: [
    ...
    buenasNoches: "Buenas noches, mirando un cielo lleno de estrellas amarillas, pensando en ti.",
    notaImagen: "[PARA TI] a tu criterio.",
...

  {
    ...
    tono: "amor",
    color: { principal: "#c9a267", suave: "#f2e0bd", oscuro: "#221805" },
    buenosDias: "Un brillo especial en cada nota para iluminar tu mañana.",
    poema: [
    ...
    buenasNoches: "Que la noche te regale paz absoluta.",
    notaImagen: "[MÚSICA] Canción: Yellow",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },
...

  {
    ...
    tono: "filosofica",
    color: { principal: "#c98f9e", suave: "#f7d9e2", oscuro: "#26101a" },
    buenosDias: "Un poco de rock alternativo para sacudir la modorra de la mañana.",
    poema: [
    ...
    buenasNoches: "Descansa rico, te quiero muchísimo.",
...

  {
    ...
    tono: "amor",
    color: { principal: "#9e8fc9", suave: "#e2d9f7", oscuro: "#160f26" },
    buenosDias: "Brillo y energía para un día que promete ser excelente.",
    poema: [
    ...
    buenasNoches: "Que descanses rico, amor.",
    notaImagen: "[MÚSICA] Canción: Yellow",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },
...

  {
    ...
    tono: "amor",
    color: { principal: "#c98f9e", suave: "#f7d9e2", oscuro: "#26101a" },
    buenosDias: "Llegamos al día 170 consolidando este viaje musical.",
    poema: [
    ...
    buenasNoches: "Descansa de la mejor manera.",
...

  {
    ...
    tono: "amor",
    color: { principal: "#9e8fc9", suave: "#e2d9f7", oscuro: "#160f26" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción sobre por fin encontrar lo que uno llevaba tiempo esperando, sin saberlo del todo.",
    poema: [
    ...
    buenasNoches: "Buenas noches, con la sensación de que por fin algo encajó bien.",
    notaImagen: "[PARA TI] a tu criterio.",
...

  {
    ...
    tono: "amor",
    color: { principal: "#6b8f9e", suave: "#c9e2ea", oscuro: "#0a1a20" },
    buenosDias: "Letras profundas que hablan de la melancolía y el amor a distancia.",
    poema: [
    ...
    buenasNoches: "Duerme bien, soñando bonito.",
    notaImagen: "[MÚSICA] Canción: Colapso",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },
...

  {
    ...
    tono: "amor",
    color: { principal: "#6b8f9e", suave: "#c9e2ea", oscuro: "#0a1a20" },
    buenosDias: "Ritmo pegadizo para dedicarle a esa persona que lo es todo.",
    poema: [
    ...
    buenasNoches: "Duerme bien, nos leemos mañana.",
    notaImagen: "[MÚSICA] Canción: Just the Way You Are",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },
...

  {
    ...
    tono: "amor",
    color: { principal: "#c9a267", suave: "#f2e0bd", oscuro: "#221805" },
    buenosDias: "Estilo alternativo con una vibra nocturna increíble.",
    poema: [
      "Quiero ser tu abrigo y tu refugio favorito,",
      "el lugar al que siempre quieras volver."
    ],
    detalle: "Que el día fluya sin errores ni complicaciones.",
    buenasNoches: "Descansa la vista de las pantallas.",
    notaImagen: "[MÚSICA] Canción: I Wanna Be Yours",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },
...

  {
    ...
    tono: "filosofica",
    color: { principal: "#c98f9e", suave: "#f7d9e2", oscuro: "#26101a" },
    buenosDias: "Ritmo pop optimista para recordarte lo especial que eres.",
    poema: [
    ...
    buenasNoches: "Que duermas bien, sabiendo lo mucho que me encantas.",
    notaImagen: "[MÚSICA] Canción: Just the Way You Are",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },
...

  {
    ...
    tono: "hot",
    color: { principal: "#b3123f", suave: "#f2b3c4", oscuro: "#170209" },
    buenosDias: "Buenos días. Tengo una segunda voz que casi no uso, y hoy tiene ganas de salir a saludar.",
    poema: [
      "Hay una versión mía más atrevida que la de todos los días, que solo aparece contigo.",
      "Hoy decidió despertarse temprano."
    ],
    detalle: "No te sorprendas si hoy hablo distinto.",
...

  {
    ...
    tono: "amor",
    color: { principal: "#c9a267", suave: "#f2e0bd", oscuro: "#221805" },
    buenosDias: "Un tema acústico para empezar la semana con los sentimientos a flote.",
    poema: [
    ...
    buenasNoches: "Que descanses rico, nos leemos mañana.",
    notaImagen: "[MÚSICA] Canción: Tú Sí Sabes Querírmeme",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },
...

  {
    ...
    tono: "amor",
    color: { principal: "#c98f9e", suave: "#f7d9e2", oscuro: "#26101a" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción que habla de lo que se construye con el tiempo, no de un solo momento.",
    poema: [
    ...
    buenasNoches: "Buenas noches, un día más elegido, como siempre.",
    notaImagen: "[MÚSICA] Canción: Colapso",
...

  {
    ...
    tono: "filosofica",
    color: { principal: "#9e8fc9", suave: "#e2d9f7", oscuro: "#160f26" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción de rock en español sobre lo indispensable que se vuelve alguien con el tiempo.",
    poema: [
    ...
    buenasNoches: "Buenas noches, respirando con calma, gracias a ti.",
    notaImagen: "[PARA TI] a tu criterio.",
...

  {
    ...
    tono: "filosofica",
    color: { principal: "#c98f9e", suave: "#f7d9e2", oscuro: "#26101a" },
    buenosDias: "Un clásico que te ayuda a reflexionar y encontrar respuestas.",
    poema: [
    ...
    buenasNoches: "Descansa rico, amor.",
    notaImagen: "[MÚSICA] Canción: The Scientist",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },
...

  {
    ...
    tono: "amor",
    color: { principal: "#6b8f9e", suave: "#c9e2ea", oscuro: "#0a1a20" },
    buenosDias: "Un clásico melancólico que nunca falla en ninguna playlist.",
    poema: [
    ...
    buenasNoches: "Que la noche te regale un descanso absoluto.",
    notaImagen: "[MÚSICA] Canción: The Scientist",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },

  {
    ...
    tono: "amor",
    color: { principal: "#c98f9e", suave: "#f7d9e2", oscuro: "#26101a" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción sobre querer a alguien exactamente como es, sin pedirle que cambie nada.",
    poema: [
    ...
    buenasNoches: "Buenas noches, tal cual eres, que ya es más que suficiente.",
    notaImagen: "[PARA TI] a tu criterio.",
...

  {
    ...
    tono: "amor",
    color: { principal: "#c9a267", suave: "#f2e0bd", oscuro: "#221805" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción sobre esa sensación de que alguien encaja contigo casi por diseño.",
    poema: [
    ...
    buenasNoches: "Buenas noches, hecha para mí, o algo muy parecido a eso.",
...

  {
    ...
    tono: "amor",
    color: { principal: "#c9a267", suave: "#f2e0bd", oscuro: "#221805" },
    buenosDias: "Ritmo fresco para un día lleno de actividades y pendientes.",
    poema: [
      "Tus ojos lindos mirando hacia el frente",
      "son la mejor vista que podría desear."
    ],
    detalle: "Ponla en tu reproductor y que suene de fondo mientras trabajas.",
    buenasNoches: "Descansa la mente de tanta pantalla.",
    notaImagen: "[MÚSICA] Canción: Ojitos Lindos",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },

  {
    ...
    tono: "amor",
    color: { principal: "#9e8fc9", suave: "#e2d9f7", oscuro: "#160f26" },
    buenosDias: "Música acústica y cálida para acompañar tu café matutino.",
    poema: [
    ...
    buenasNoches: "Que tengas una noche muy tranquila y reparadora.",
    notaImagen: "[MÚSICA] Canción: Tú Sí Sabes Querírmeme",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },
...

  {
    ...
    tono: "filosofica",
    color: { principal: "#c9a267", suave: "#f2e0bd", oscuro: "#221805" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción sobre las ganas de llegar a algún lugar solo para estar con alguien.",
    poema: [
    ...
    buenasNoches: "Buenas noches, con ganas de acortar cualquier distancia entre los dos.",
    notaImagen: "[PARA TI] a tu criterio.",
...

  {
    ...
    tono: "amor",
    color: { principal: "#9e8fc9", suave: "#e2d9f7", oscuro: "#160f26" },
    buenosDias: "Estilo británico clásico con una letra que se queda grabada.",
    poema: [
    ...
    buenasNoches: "Que descanses y recargues baterías.",
    notaImagen: "[MÚSICA] Canción: I Wanna Be Yours",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },

  {
    ...
    tono: "hot",
    color: { principal: "#b3123f", suave: "#f2b3c4", oscuro: "#170209" },
    buenosDias: "Buenos días. Hay canciones que solo suenan bien cuando estamos los dos, sin nadie más alrededor.",
    poema: [
      "No hablo de una canción cualquiera, hablo de esas que se disfrutan mejor cerca, en voz baja, sin prisa.",
      "Ya tengo varias guardadas para cuando estemos a solas."
    ],
    detalle: "Prepárate, tengo buen gusto para esos momentos.",
    buenasNoches: "Buenas noches, guardando canciones para cuando estemos a solas.",
    notaImagen: "[PARA TI] a tu criterio.",
    notaCancion: "[PARA TI] automática, catálogo 'hot'."
  },
...

  {
    ...
    tono: "amor",
    color: { principal: "#9e8fc9", suave: "#e2d9f7", oscuro: "#160f26" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción sobre un amor que se siente como si llevara esperando mucho más tiempo del que en realidad lleva.",
    poema: [
    ...
    buenasNoches: "Buenas noches, agradecido de no tener que esperar más.",
    notaImagen: "[PARA TI] a tu criterio.",
...

  {
    ...
    tono: "amor",
    color: { principal: "#9e8fc9", suave: "#e2d9f7", oscuro: "#160f26" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción de rock en español bien simple en su mensaje: que alguien lo es todo.",
    poema: [
    ...
    buenasNoches: "Buenas noches, siendo simple y claro: eres mucho para mí.",
    notaImagen: "[PARA TI] a tu criterio.",
...

  {
    ...
    tono: "filosofica",
    color: { principal: "#6b8f9e", suave: "#c9e2ea", oscuro: "#0a1a20" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción que, aunque es triste, me hace valorar más lo que tenemos.",
    poema: [
    ...
    buenasNoches: "Buenas noches, agradecido de no tener que pensarte desde la distancia.",
    notaImagen: "[MÚSICA] Canción: La Mitad",
...

  {
    ...
    tono: "amor",
    color: { principal: "#6b8f9e", suave: "#c9e2ea", oscuro: "#0a1a20" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción sobre esa cosa en alguien que atrae sin que uno pueda explicar bien por qué.",
    poema: [
    ...
    buenasNoches: "Buenas noches, todavía sin poder explicar bien ese algo tuyo.",
    notaImagen: "[PARA TI] a tu criterio.",
...

  {
    ...
    tono: "amor",
    color: { principal: "#9e8fc9", suave: "#e2d9f7", oscuro: "#160f26" },
    buenosDias: "Letras profundas de rap consciente para reflexionar un momento.",
    poema: [
    ...
    buenasNoches: "Que tengas una noche muy tranquila.",
    notaImagen: "[MÚSICA] Canción: Querer Querernos",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },
...

  {
    ...
    tono: "filosofica",
    color: { principal: "#c98f9e", suave: "#f7d9e2", oscuro: "#26101a" },
    buenosDias: "Música alegre para recordarte que las cosas bonitas toman su tiempo.",
    poema: [
...

  {
    ...
    tono: "amor",
    color: { principal: "#c9a267", suave: "#f2e0bd", oscuro: "#221805" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción sobre ver en alguien algo que nadie más nota.",
    poema: [
    ...
    buenasNoches: "Buenas noches, viendo en ti lo mismo de siempre: mucho.",
    notaImagen: "[MÚSICA] Canción: Ojitos Lindos",
...

  {
    ...
    tono: "hot",
    color: { principal: "#c81d4a", suave: "#f7c0d0", oscuro: "#1a0308" },
    buenosDias: "Buenos días, aunque este mensaje tiene más de madrugada que de mañana en lo que dice.",
    poema: [
      "Hay una hora rara de la noche en la que pienso en ti de una forma nada inocente.",
      "Si me ves con cara de poco dormida, ya sabes en qué estaba pensando."
    ],
    detalle: "Pregúntame en qué pensaba, si te atreves.",
    buenasNoches: "Buenas noches, con la madrugada todavía en la cabeza.",
    notaImagen: "[PARA TI] a tu criterio.",
    notaCancion: "[PARA TI] automática, catálogo 'hot'."
  },

  {
    ...
    tono: "amor",
    color: { principal: "#9e8fc9", suave: "#e2d9f7", oscuro: "#160f26" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción que describe el amor como algo que libera, no que encierra.",
    poema: [
    ...
    buenasNoches: "Buenas noches, libre y tranquilo, gracias a ti.",
    notaImagen: "[MÚSICA] Canción: Tú Sí Sabes Querírmeme",
...

  {
    ...
    buenasNoches: "Que duermas bien, te pienso un montón.",
    notaImagen: "[MÚSICA] Canción: Contigo",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },
...

  {
    ...
    tono: "amor",
    color: { principal: "#c9a267", suave: "#f2e0bd", oscuro: "#221805" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción colombiana que va perfecto con todo lo que hemos hablado de flores en este calendario.",
    poema: [
    ...
    buenasNoches: "Buenas noches, con flores imaginarias mandadas hacia tu lado.",
    notaImagen: "[PARA TI] a tu criterio.",
...

  {
    ...
    tono: "amor",
    color: { principal: "#c9a267", suave: "#f2e0bd", oscuro: "#221805" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción que describe bastante bien esa etapa bonita del principio de algo.",
    poema: [
    ...
    buenasNoches: "Buenas noches, con esa misma magia del principio todavía intacta.",
    notaImagen: "[MÚSICA] Canción: Querer Querernos",
...

  {
    ...
    tono: "amor",
    color: { principal: "#9e8fc9", suave: "#e2d9f7", oscuro: "#160f26" },
    buenosDias: "Ritmo fresco para alegrar la mañana más pesada.",
    poema: [
    ...
    buenasNoches: "Que la noche te regale un descanso reparador.",
    notaImagen: "[MÚSICA] Canción: Ojitos Lindos",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },
...

  {
    ...
    tono: "amor",
    color: { principal: "#c98f9e", suave: "#f7d9e2", oscuro: "#26101a" },
    buenosDias: "¡Llegamos al día 150! Y se celebra con música que marca momentos.",
    poema: [
    ...
    buenasNoches: "Que descanses de la mejor manera, amor. Mañana seguimos sumando.",
    notaImagen: "[MÚSICA] Canción: La Mitad",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },
...

  {
    ...
    tono: "amor",
    color: { principal: "#6b8f9e", suave: "#c9e2ea", oscuro: "#0a1a20" },
    buenosDias: "Melodías dulces para recordar que eres mi mitad favorita.",
    poema: [
...

  {
    ...
    tono: "amor",
    color: { principal: "#c9a267", suave: "#f2e0bd", oscuro: "#221805" },
    buenosDias: "Vibra caribeña y latina para arrancar el día con buena energía.",
    poema: [
    ...
    buenasNoches: "Que duermas de maravilla.",
    notaImagen: "[MÚSICA] Canción: Dámelo Todo",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },
...

  {
    ...
    tono: "amor",
    color: { principal: "#c9a267", suave: "#f2e0bd", oscuro: "#221805" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción sobre estar dispuesto a hacer lo que sea por un solo beso.",
    poema: [
    ...
    buenasNoches: "Buenas noches, con un beso pendiente todavía en el aire.",
    notaImagen: "[PARA TI] a tu criterio.",
...

  {
    ...
    tono: "amor",
    color: { principal: "#6b8f9e", suave: "#c9e2ea", oscuro: "#0a1a20" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción sobre entregarse completo, curvas, dudas y todo lo demás incluido.",
    poema: [
    ...
    buenasNoches: "Buenas noches, completo, con todas mis partes puestas en esto.",
...

  {
    ...
    tono: "filosofica",
    color: { principal: "#c98f9e", suave: "#f7d9e2", oscuro: "#26101a" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción vieja de rock sobre esos momentos con alguien que se sienten casi irreales de lo bien que están.",
    poema: [
    ...
    buenasNoches: "Buenas noches, todavía en uno de esos momentos casi de sueño.",
    notaImagen: "[PARA TI] a tu criterio.",
...

  {
    ...
    tono: "amor",
    color: { principal: "#9e8fc9", suave: "#e2d9f7", oscuro: "#160f26" },
    buenosDias: "Ritmos tropicales y alternativos para levantar el ánimo de inmediato.",
    poema: [
    ...
    buenasNoches: "Que el descanso limpie tu mente de cualquier carga.",
    notaImagen: "[MÚSICA] Canción: Ojitos Lindos",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },

  {
    ...
    tono: "amor",
    color: { principal: "#c9a267", suave: "#f2e0bd", oscuro: "#221805" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción sobre encontrar a alguien real, sin necesidad de que sea perfecto para que se sienta perfecto.",
    poema: [
    ...
    buenasNoches: "Buenas noches, con ganas de bailar contigo algún día, descalzos, sin ocasión especial.",
...

  {
    ...
    tono: "filosofica",
    color: { principal: "#6b8f9e", suave: "#c9e2ea", oscuro: "#0a1a20" },
    buenosDias: "Una canción dedicada a lo increíble que es alguien tal cual como es.",
    poema: [
    ...
    buenasNoches: "Descansa, aunque sé que vas a terminar tarareándola en sueños.",
    notaImagen: "[MÚSICA] Canción: Just the Way You Are",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },

  {
    ...
    tono: "amor",
    color: { principal: "#9e8fc9", suave: "#e2d9f7", oscuro: "#160f26" },
    buenosDias: "Vibras relajadas y letras con sentido para empezar bien el día.",
    poema: [
    ...
    buenasNoches: "Que duermas plácidamente.",
    notaImagen: "[MÚSICA] Canción: Dámelo Todo",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },
...

  {
    ...
    tono: "amor",
    color: { principal: "#9e8fc9", suave: "#e2d9f7", oscuro: "#160f26" },
    buenosDias: "Un recordatorio musical de que los detalles pequeños son los que más importan.",
    poema: [
    ...
    buenasNoches: "Que el silencio de la noche te traiga calma.",
    notaImagen: "[MÚSICA] Canción: Amor Completo",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },
...

  {
    ...
    tono: "filosofica",
    color: { principal: "#c98f9e", suave: "#f7d9e2", oscuro: "#26101a" },
    buenosDias: "Una melodía tierna para recordarte que eres mi constante favorita.",
    poema: [
...

  {
    ...
    tono: "filosofica",
    color: { principal: "#c98f9e", suave: "#f7d9e2", oscuro: "#26101a" },
    buenosDias: "Acordes acústicos que hablan de quedarse cuando todo lo demás se mueve.",
    poema: [
    ...
    buenasNoches: "Duerme bien, nos leemos mañana con más calma.",
    notaImagen: "[MÚSICA] Canción: Colapso",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },
...

  {
    ...
    poema: [
      "Hay una distancia justa que me gusta contigo, y hoy la quiero más corta que de costumbre.",
      "Cuando te vea, prepárate para que no respete el espacio personal."
    ],
    detalle: "Aparta un buen rato para estar cerca la próxima vez.",
...

  {
    ...
    tono: "amor",
    color: { principal: "#6b8f9e", suave: "#c9e2ea", oscuro: "#0a1a20" },
    buenosDias: "Llegamos al día 160 con buena música sonando de fondo.",
    poema: [
    ...
    buenasNoches: "Descansa rico, nos leemos mañana temprano.",
    notaImagen: "[MÚSICA] Canción: Creep",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },
...

  {
    ...
    tono: "hot",
    color: { principal: "#b3123f", suave: "#f2b3c4", oscuro: "#170209" },
    buenosDias: "Buenos días. Hoy tengo un pensamiento que probablemente no debería tener tan temprano.",
    poema: [
      "Hay pensamientos que uno sabe que no debería tener en horario laboral, y aun así aparecen.",
      "Este es de esos, cortesía tuya, sin que hicieras nada en particular."
    ],
    detalle: "Si me ves distraído hoy, ya sabes de quién es la culpa.",
    buenasNoches: "Buenas noches, con el pensamiento prohibido todavía rondando.",
    notaImagen: "[PARA TI] a tu criterio.",
    notaCancion: "[PARA TI] automática, catálogo 'hot'."
  },

  {
    ...
    tono: "filosofica",
    color: { principal: "#c98f9e", suave: "#f7d9e2", oscuro: "#26101a" },
    buenosDias: "Un toque de rock alternativo para sacudir la rutina matutina.",
    poema: [
    ...
    buenasNoches: "Descansa rico, amor mío.",
    notaImagen: "[MÚSICA] Canción: Creep",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },

  {
    ...
    tono: "amor",
    color: { principal: "#6b8f9e", suave: "#c9e2ea", oscuro: "#0a1a20" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción bachatera bien tierna, de esas que parecen escritas para decir cosas imposibles de forma bonita.",
    poema: [
    ...
    buenasNoches: "Buenas noches, convertido en algo pequeño y cerca tuyo, aunque sea solo en la imaginación.",
    notaImagen: "[PARA TI] a tu criterio.",
...

  {
    ...
    tono: "amor",
    color: { principal: "#c9a267", suave: "#f2e0bd", oscuro: "#221805" },
    buenosDias: "Empezar la jornada con acordes luminosos cambia por completo la energía.",
    poema: [
    ...
    buenasNoches: "Que nada te arrebate la paz hoy. Descansa.",
    notaImagen: "[MÚSICA] Canción: Yellow",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },
...

  {
    ...
    tono: "amor",
    color: { principal: "#9e8fc9", suave: "#e2d9f7", oscuro: "#160f26" },
    buenosDias: "Buenos días. Hoy quiero hablarte de una canción sobre el orgullo de la propia tierra y las ganas de celebrar la vida.",
    poema: [
    ...
    buenasNoches: "Buenas noches, con ganas de esa bailada pendiente.",
...

  {
    ...
    tono: "amor",
    color: { principal: "#c9a267", suave: "#f2e0bd", oscuro: "#221805" },
    buenosDias: "Baladas intensas para los momentos donde se extraña de verdad.",
    poema: [
    ...
    buenasNoches: "Duerme con la tranquilidad de que te pienso un montón.",
    notaImagen: "[MÚSICA] Canción: Amor Completo",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },
...

  {
    ...
    tono: "amor",
    color: { principal: "#6b8f9e", suave: "#c9e2ea", oscuro: "#0a1a20" },
    buenosDias: "Un clásico melancólico que invita a pensar bonito.",
    poema: [
...

  {
    ...
    tono: "hot",
    color: { principal: "#e0294f", suave: "#ffc9d6", oscuro: "#20050b" },
    buenosDias: "Buenos días. Hoy no tengo ganas de apuro para nada, ni siquiera para esto.",
    poema: [
      "Hay momentos que se disfrutan mejor lento, sin correr a ningún lado, sin mirar el reloj.",
      "Contigo quiero ese ritmo lento, en todo sentido."
    ],
    detalle: "No hay afán, vamos despacio, como debe ser esta vez.",
    buenasNoches: "Buenas noches, en ritmo lento, pensando en ti.",
    notaImagen: "[PARA TI] a tu criterio.",
    notaCancion: "[PARA TI] automática, catálogo 'hot'."
  },

  {
    ...
    tono: "amor",
    color: { principal: "#6b8f9e", suave: "#c9e2ea", oscuro: "#0a1a20" },
    buenosDias: "Un toque de rock clásico para despertar con fuerza.",
    poema: [
    ...
    buenasNoches: "Que descanses profundamente, amor.",
    notaImagen: "[MÚSICA] Canción: Creep",
    notaCancion: "[PARA TI] la música de este día se elige sola del catálogo (no verifiqué el artista original que traía este bloque, así que no lo mantuve como referencia)."
  },
...

  {
    ...
    tono: "hot",
    color: { principal: "#d1163f", suave: "#f7bccb", oscuro: "#1c0409" },
    buenosDias: "Buenos días. Tengo un pensamiento de hoy que califica como 'contenido no apto para todo público'.",
    poema: [
      "No todo lo que pienso de ti es para compartir en cualquier momento, algunas cosas son solo para cuando estemos a solas.",
      "Este es uno de esos pensamientos, guardado bajo llave por ahora."
    ],
    detalle: "La llave la tienes tú, solo tienes que pedirla.",
    buenasNoches: "Buenas noches, con el pensamiento todavía bajo llave.",
    notaImagen: "[PARA TI] a tu criterio.",
    notaCancion: "[PARA TI] automática, catálogo 'hot'."
  },

  {
    ...
    poema: [
      "No se me ha olvidado, para nada, sigue en la lista de pendientes más deseados.",
      "Cuando quieras cobrarlo, aquí estoy, disponible por completo."
    ],
    detalle: "Cóbrame ese bis pendiente cuando quieras, en serio.",
    buenasNoches: "Buenas noches, con el bis todavía en deuda.",
    notaImagen: "[PARA TI] a tu criterio.",
    notaCancion: "[PARA TI] automática, catálogo 'hot'."
  },

  {
    ...
    tono: "hot",
    color: { principal: "#c81d4a", suave: "#f7c0d0", oscuro: "#1a0308" },
    buenosDias: "Buenos días. Hoy quiero estar sintonizado contigo, en la misma frecuencia, cerca, sin interferencia.",
    poema: [
      "Hay una frecuencia que solo se sintoniza bien cuando estamos cerca, sin distancia de por medio.",
      "Hoy tengo muchas ganas de esa buena señal contigo."
    ],
    detalle: "Avísame cuándo podemos sintonizar esa frecuencia otra vez, en persona.",
    buenasNoches: "Buenas noches, buscando buena señal contigo.",
    notaImagen: "[PARA TI] a tu criterio.",
    notaCancion: "[PARA TI] automática, catálogo 'hot'."
  }
